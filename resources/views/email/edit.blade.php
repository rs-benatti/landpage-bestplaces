...
@section('conteudo')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="content">
                    <div class="create">{{ __('Edição de mensagem') }}</div>
                    <hr>

                    <div class="">
                        <form method="POST" enctype="multipart/form-data" action="{{ route('email.update',$email) }}">
                            @csrf
                            {{ csrf_field() }}
                            {{ method_field('PUT') }}
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="title" type="text" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ $email->title }}" required autocomplete="title" autofocus>
