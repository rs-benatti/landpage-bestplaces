...
<body>
    ...
    <div class="img-grid">
        <div class="b11" onmouseover="rotate(this)" name="rotateName">
            <div class="back-block" id="b11">
                <div class="back-title reverse">
                    SEGURO DE AUTOMÓVEL
                </div>
                <div class="back-body reverse">
                    Diante de tantos aspectos,
                    percebe-se que o seguro auto é
                    mais do que essencial. O ideal é
                    fazê-lo assim que sair da
                    concessionária. Não queremos
                    nunca que aconteça qualquer
                    acidente. Mas caso aconteçam
                    bom que tenhamos o nosso
                    seguro. Carro é um bem muito
                    caro e desejado por qualquer
                    brasileiro para não se ter um
                    seguro.
                </div>
            </div>
        </div>
        <div class="b12" onmouseover="rotate(this)" name="rotateName">
        ...
        <div class="b13" onmouseover="rotate(this)" name="rotateName">
        ...
        <div class="b21" onmouseover="rotate(this)" name="rotateName">
        ...
        <div class="b22" onmouseover="rotate(this)" name="rotateName">
        ...
        <div class="b23" onmouseover="rotate(this)" name="rotateName">
            <div class="back-block" id="b23">
                ...
                <div class="back-body reverse">
                    ...
                    cuidado com a sua família é
                    proporcionando segurança, estabilidade,
                    proteção e tranquilidade,
                    o que contribui para uma
                    excelente qualidade de vida.
                    Sua família merece proteção
                    porque representa o bem mais
                    precioso que você possui. A importância
                    do Seguro de Vida Individual
                    vai além do que você
                    costuma imaginar.
                </div>
            </div>
        </div>
    </div>
    <div class="final-blue-headline" onmouseover="desrotate()">
